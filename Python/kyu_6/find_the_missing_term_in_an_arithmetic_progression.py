def find_missing(sequence):
    ...
    You have to write the function findMissing(list), list will always be at least 3 numbers. The missing term will
    ...
    for idx, elem in enumerate(sequence):
        if elem + step != sequence[idx + 1]:
            return elem + step


print(find_missing([1, 3, 5, 7, 9, 13]))
